...
export const fares: Fare[] = [
  ...
  { from: 'dakshineswar', to: 'shyambazar', fare: 15 },
  { from: 'dakshineswar', to: 'shobhabazar-sutanuti', fare: 15 },
  { from: 'dakshineswar', to: 'girish-park', fare: 15 },
  ...
  { from: 'dakshineswar', to: 'netaji-bhavan', fare: 25 },
  { from: 'dakshineswar', to: 'jatindas-park', fare: 25 },
  ...
  { from: 'dum-dum', to: 'kavi-subhash', fare: 20 },
  { from: 'dum-dum', to: 'mahanayak-uttam-kumar', fare: 15 },
  { from: 'esplanade', to: 'kavi-subhash', fare: 15 },
  { from: 'esplanade', to: 'mahanayak-uttam-kumar', fare: 10 },
